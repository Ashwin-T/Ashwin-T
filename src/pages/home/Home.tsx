    ...
    const projects = [
      {
        ...
        "link": "https://github.com/RetroSpecs-Suite", // Add the deployed link when available
        "github": "https://github.com/RetroSpecs-Suite", // Add the main repository link when available
        "timeline": "November 2024",
        "borderColor": 'black',
        "backgroundColor": "white",
        "highlights": "RetroSpecs is a revolutionary smart glasses system built during CheeseHacks 2024 (& won 1st place) that helps individuals with Alzheimer's maintain independence through AI-powered memory assistance. The system continuously captures daily activities, via a device that attatches to your glasses, and allows natural language querying of experiences (kinda like talking to a chatbot). Built using React.js frontend, Flask backend, Raspberry Pi based glasses add on, and leverages OpenAI and ChromaDB for image analysis and retrival. "
      },
      {
        "name": "Hiro",
        ...
        <main>
          ...
          <div className="content">
            <div className="content-bit" id = "about">
              <h4>About</h4>
              <p>Hello! I'm Ashwin Talwalkar, a third-year Computer Science student at UW-Madison and an aspiring Software Engineer. Whether it's full-stack, machine learning, or embedded devices - I'm passionate about all aspects of software engineering. With an open mind and eagerness to learn, I'm currently on the lookout for exciting internship opportunities for Summer 2025.</p>
              <br/>
              ...
              <br/>
              <p>Outside of school, I enjoy reading Calvin and Hobbes, playing sports, lifting weights, and learning new life skills.<br/></p>
            </div>
            <div className="content-bit" id="current">
              <h4>Currently</h4>
              <p>At the moment I am a Tech Lead and Club Executive for <a href = 'https://madison.dssdglobal.org/' target="_blank" style = {{'color': 'green'}}>Data Science for Sustainable Development</a>: A club that creates software tools for non-profit organizations. Currently leading my second technical team developing software solutions in collaboration with the UW-Madison Office of Sustainability and Operations</p>
              <br />
              <p>I also am taking 14 credits in my spring semester</p>
          </div>
